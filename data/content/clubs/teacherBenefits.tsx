...
const benefits = [
  {
    title: 'Help students find their passion for economics',
    content:
  ...
  {
    title: 'Instill student’s with leadership qualities',
    content:
  ...
  {
    title: 'Simplify the process of starting an Economics Club',
    content:
      'With three simple steps, you can establish your own regional chapter of the YEI.',
    icon: faObjectGroup,
  },
  {
    title: 'Open a pathway for student’s to explore economics in the future',
    content:
