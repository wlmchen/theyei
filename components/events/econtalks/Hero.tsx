    ...
    <>
      ...
      >
        <div className="z-10 relative container py-20 px-4 sm:py-24 sm:px-6 lg:px-8">
          <img src="/img/logos/econtalks.png" className="mx-auto w-max-screen w-64" alt="econtalks logo" />
          <p className="mt-5 text-xl sm:text-2xl text-gray-800 space-y-4 max-w-3xl mx-auto">
