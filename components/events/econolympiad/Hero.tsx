          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <div className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                <p className="mt-3 ">
                  Earn cash prizes while applying your knowledge in a team based
                  competition to answer written questions & brainstorm solutions
                  for current economic issues!
                </p>
                <p className="mt-8">
                  Please note that EconOlympiad is an event exclusive to YEI
                  members. If your school is not yet a registered club, you can
                  sign up{" "}
            ...
            <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
              ...
              <div className="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
                ...
                >
                                  ...
                                  <p className="py-28 text-white text-3xl font-bold uppercase">Video coming soon!</p>
                  {/* <img
                    className="w-full"
