    ...
    <>
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-3">
          <fieldset>
            <legend className="block text-xl font-medium text-gray-700">
              Are you planning to register a <b>pre-existing club</b> or are you{" "}
              <b>starting a new chapter</b> at your school?
            </legend>
        ...
        <div className="col-span-3">
          ...
          >
            We'll also need some info about other officers to get started. Let's
            get their <b>names, emails, grade levels, and positions.</b>
          </label>
