      ...
      <aside className="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
        <nav className="space-y-1">
          {[
            ...
            let styles =
              "cursor-pointer trans-150 group rounded-md px-3 py-2 flex items-center text-md font-medium " +
              (active
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="col-span-3 sm:col-span-2">
                  ...
                  <div className="mt-1 rounded-md shadow-sm flex">
                    ...
                    <input
                      ...
                      className="focus:ring-yei-primary-main focus:border-yei-primary-main flex-grow block w-full min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300"
                    />
                  </div>
                </div>
                ...
                <div className="col-span-3">
                  ...
                  <div className="mt-1 flex items-center">
                    ...
                    <button
                      type="button"
                      className="ml-5 bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yei-primary-main"
                    >
                      Change
                    </button>
                  </div>
                  ...
                  <div className="mt-2 border-2 border-gray-300 border-dashed rounded-md px-6 pt-5 pb-6 flex justify-center">
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600">
                        <label
                          htmlFor="file-upload"
                          className="relative cursor-pointer bg-white rounded-md font-medium text-yei-primary-main hover:text-yei-primary-main focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-yei-primary-main"
                        >
