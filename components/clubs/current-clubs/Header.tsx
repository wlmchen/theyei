...
function Header() {
  return (
    <div className="pt-16 pb-12">
      ...
      <h2 className=" text-center font-extrabold text-5xl mb-4">All Clubs</h2>
      <div className="text-gray-600 text-xl space-y-4">
        <p className="text-lg sm:text-xl text-gray-600 max-w-lg m-auto text-center">
          View the YEI's {currentClubs.length} clubs. Want to join the epic
          list? Learn more at our{' '}
          <Link href="/clubs">
