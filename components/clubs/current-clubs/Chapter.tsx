...
export default function Chapter({ name, imgSrc, email, founding, primaryFounding, region }) {
  return (
    <li className="sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 mb-2">
      <div className="space-y-4">
        <div className="overflow-hidden w-full h-auto shadow-lg rounded-lg">
          <img
            className="object-cover transform transition ease-in-out duration-500 hover:scale-105 scale-100"
            src={imgSrc}
            alt={name}
          />
        </div>
